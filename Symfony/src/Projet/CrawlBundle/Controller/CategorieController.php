...
use Projet\CrawlBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ProjetCrawlBundle:Categorie')->findAll();
     ...
     * @Method("POST")
     * @Template("ProjetCrawlBundle:Categorie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ProjetCrawlBundle:Categorie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ProjetCrawlBundle:Categorie:edit.html.twig")
     */
